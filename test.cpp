...
int main(int argc, char **argv)
{
    ...
    int inDeg = 2;//readFile(filename, eqn); //Read polynomial from file
    eqn.fileSetCoef(inDeg, coefA);
    eqn2.fileSetCoef(inDeg, coefA);
    eqn.dispPoly();
